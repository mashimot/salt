...
(function(){
    ...
    FormBuilderController.$inject = ['$scope', '$q', '$uibModal', 'LanguageToolService', 'DominioService', 'HtmlElementsService', 'formDataService'];

    function FormBuilderController($scope, $q, $uibModal, LanguageToolService, DominioService, HtmlElementsService, formDataService ){
        var vm = this;
        vm.preview             = '';
        vm.rows                = [];
        vm.pages               = [];
